    ...
    <section id="home" className="min-h-screen flex items-center justify-center pt-16 bg-background">
      <div className="max-w-6xl mx-auto px-6 py-20">
        <div className="space-y-8 text-center md:text-left">
          ...
          <h1 className="text-4xl md:text-6xl font-bold leading-tight slide-up text-foreground">
          ...
          <div className="flex flex-col md:flex-row items-center gap-4 pt-4 slide-up" style={{ animationDelay: '0.3s' }}>
            <button
              ...
              className="group inline-flex items-center gap-2 bg-primary text-primary-foreground px-8 py-4 rounded-full transition-all hover:bg-primary/90 hover:shadow-lg"
            >
              View My Work
